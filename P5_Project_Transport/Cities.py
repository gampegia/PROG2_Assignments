...
# Define your data
data = {
    "City": ['Altach', 'Altstaetten', 'Arbon', 'Au', 'Balzers', 'Basel', 'Bregenz', 'Buchs', 'Diepoldsau', 'Dornbirn', 'Eichberg', 'Feldkirch', 'Friedrichshafen', 'Gams', 'Haag', 'Heerbrugg', 'Koblach', 'Konstanz', 'Kreuzlingen', 'Kriessern', 'Kuessaberg', 'Lindau', 'Loerrach', 'Lustenau', 'Maeder', 'Montlingen', 'Mulhouse', 'Oberriet', 'Rankweil', 'Rheinfelden', 'Romanshorn', 'Rorschach', 'Rueti', 'Rueti', 'Sankt-Ludwig', 'Sankt-Gallen', 'Sargans', 'Schaan', 'Schaffhausen', 'Sevelen', 'Singen', 'St.Margrethen', 'Ueberlingen', 'Vaduz', 'Waldshut-Tiengen', 'Weil-am-Rhein', 'Widnau', 'Mailand', 'Como', 'Pontarlier', 'Morteau'],
    "Country": ['Oesterreich', 'Schweiz', 'Schweiz', 'Schweiz', 'Liechtenstein', 'Schweiz', 'Oesterreich', 'Schweiz', 'Schweiz', 'Oesterreich', 'Schweiz', 'Oesterreich', 'Deutschland', 'Schweiz', 'Schweiz', 'Schweiz', 'Oesterreich', 'Deutschland', 'Schweiz', 'Schweiz', 'Deutschland', 'Deutschland', 'Deutschland', 'Oesterreich', 'Oesterreich', 'Schweiz', 'Frankreich', 'Schweiz', 'Oesterreich', 'Schweiz', 'Schweiz', 'Schweiz', 'Schweiz', 'Liechtenstein', 'Frankreich', 'Schweiz', 'Schweiz', 'Liechtenstein', 'Schweiz', 'Schweiz', 'Deutschland', 'Schweiz', 'Deutschland', 'Liechtenstein', 'Deutschland', 'Deutschland', 'Schweiz', 'Italien', 'Italien', 'Frankreich', 'Frankreich']
}
