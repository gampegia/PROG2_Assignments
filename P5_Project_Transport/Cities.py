...
def create_cities_dataframe():
    ...
    # Define your data
    data = {
        "City": ['Altstätten-SG', 'Arbon', 'Au-ZH', 'Balzers', 'Basel-SBB', 'Bregenz', 'Buchs-SG', 'Diepoldsau', 'Dornbirn-Bahnhof', 'Linz', 'Feldkirch-Bahnhof', 'Friedrichshafen-Stadt', 'Gams', 'Haag', 'Heerbrugg', 'Koblach', 'Konstanz', 'Kreuzlingen', 'Kriessern', 'Küssaberg', 'Lindau', 'Lörrach-Stetten', 'Lustenau', 'Mäder', 'Montlingen-Hirschen', 'Mulhouse', 'Oberriet-SG', 'Rankweil', 'Rheinfelden-Bahnhof', 'Romanshorn', 'Rorschach', 'Rüthi-SG', 'Mulhouse', 'St.-Gallen', 'Sargans', 'Schaan-Bahnhof', 'Schaffhausen-Bahnhof', 'Sevelen-Bahnhof', 'Singen', 'St.Margrethen', 'Überlingen', 'Waldshut-Tiengen', 'Weil-am-Rhein', 'Widnau', 'Mailand', 'Como-S.-Giovanni', 'Genève', 'Lausanne', 'Sion', 'Biel/Bienne'],
