...
class TrainConnectionMenu:
    ...
    def get_train_website(self):
        ...
        """
        try:
            self.destination_country = self.destination_country.lower()
        ...
        if self.start_city and self.destination_city:
            try:
                ...
                if connection:
                    ...
                    msg_not_found = f"No direct connection found. The nearest station to {self.destination_city} is {next_station}."
                ...
                msg_invalide_route =f"An unexpected error occurred while displaying the connection: {e}"
                TrainConnectionMenu.set_console_output(msg_invalide_route)
        else:
            msg_invalide_route = "Please input a valid route first."
            TrainConnectionMenu.set_console_output(msg_invalide_route)
